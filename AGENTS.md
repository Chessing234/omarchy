...
This copies `$OMARCHY_PATH/config/hypr/hyprland.lua` to `~/.config/hypr/hyprland.lua`. Pass a plain
relative path under `config/`; absolute paths, `..` components, and newlines are rejected.
